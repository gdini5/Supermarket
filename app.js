...
// Definir sempre com valor por defeito para evitar "X is not defined" no EJS
app.use((req, res, next) => {
  res.locals.currentUser = req.session && req.session.userId ? req.session.userId : null;
  res.locals.currentRole = req.session && req.session.role   ? req.session.role   : null;
  next();
});
